            ...
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                <div class="card  box-shadow-0">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <form class="form-horizontal" method="post" action="{{route('cms.category.update', $category->id)}}">
                            @method('PUT')
                            @csrf
                            <div class="form-group">
                                <input type="text" value="{{old('name', $category->name)}}" class="form-control" id="inputName" name="name" placeholder="Name">
                            </div>
                            ...
                            <div class="form-group mb-0 justify-content-end">
                                ...
                                <input type="hidden" name="is_active" id="btn-active" value="{{old('is_active', $category->is_active)}}">
